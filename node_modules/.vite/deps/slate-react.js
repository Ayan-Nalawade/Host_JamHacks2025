...
var Text2 = (props) => {
  var {
    ...
    renderPlaceholder,
    renderLeaf,
    renderText = (props2) => import_react.default.createElement(DefaultText, _objectSpread$2({}, props2)),
    text
  } = props;
  var editor = useSlateStatic();
  var ref = (0, import_react.useRef)(null);
...
var DefaultText = (props) => {
  ...
  return import_react.default.createElement("span", _objectSpread$2({}, attributes), children);
};
...
var Element3 = (props) => {
  var {
    decorations,
    element,
    renderElement = (p) => import_react.default.createElement(DefaultElement, _objectSpread$1({}, p)),
    renderPlaceholder,
    renderLeaf,
    renderText,
    selection
...
var DefaultElement = (props) => {
  ...
  return import_react.default.createElement(Tag, _objectSpread$1(_objectSpread$1({}, attributes), {}, {
    style: {
      position: "relative"
    }
  }), children);
